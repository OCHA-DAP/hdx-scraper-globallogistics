# Collector for Global Logistics Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-globallogistics/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-globallogistics/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-globallogistics/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-globallogistics?branch=main)
 ...
 **hdx-scraper-globallogistics** as specified in the parameter
 *user_agent_lookup*.
...
```shell
    pip install .
    python -m hdx.scraper.globallogistics
```
